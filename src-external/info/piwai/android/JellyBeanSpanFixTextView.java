...
public class JellyBeanSpanFixTextView extends TextView
{
	...
	public JellyBeanSpanFixTextView(Context context, AttributeSet attrs, int defStyleAttr)
	{
	...
	private void fixOnMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		else fallbackToString(widthMeasureSpec, heightMeasureSpec);
	}
	...
	private void fixSpannedWithSpaces(SpannableStringBuilder builder, int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		if (result.fixed) removeUnneededSpaces(widthMeasureSpec, heightMeasureSpec, builder, result);
		else fallbackToString(widthMeasureSpec, heightMeasureSpec);
	}
	
	private FixingResult addSpacesAroundSpansUntilFixed(SpannableStringBuilder builder, int widthMeasureSpec,
	...
	@SuppressLint("WrongCall")
	private void removeUnneededSpaces(int widthMeasureSpec, int heightMeasureSpec, SpannableStringBuilder builder,
			FixingResult result)
	{
